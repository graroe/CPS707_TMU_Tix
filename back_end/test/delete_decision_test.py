...
for file_name in os.listdir("test/delete_decision_test_files/"):
    with open("test/delete_decision_test_files/" + file_name) as in_file:
...
with open("test/expected_outputs/delete_decision_test.out") as e_file:
...
with open("test/expected_outputs/delete_master_event.out") as e_m_file:
    expected_master_file = e_m_file.read()
with open("test/expected_outputs/delete_current_event.out") as e_c_file:
